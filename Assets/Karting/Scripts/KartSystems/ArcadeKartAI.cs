...
namespace KartGame.KartSystems
{
    public class ArcadeKartAI : MonoBehaviour
    {
        ...
        {
            public ArcadeKartAI.Stats modifiers;
        ...
        public ArcadeKartAI.Stats baseStats = new ArcadeKartAI.Stats
        {
            TopSpeed = 10f,
            Acceleration = 5f,
        ...
        ArcadeKartAI.Stats m_FinalStats;
        ...
        void Awake()
        {
            ...
            // Guardar los valores originales de velocidad y aceleración
            originalTopSpeed = baseStats.TopSpeed;
            originalAcceleration = baseStats.Acceleration;
        }
        ...
        public void ReduceSpeed(int minValueSpeed, int minValueAcce)
        {
            baseStats.TopSpeed = Mathf.Clamp(baseStats.TopSpeed * 0.5f, minValueSpeed, baseStats.TopSpeed);
            baseStats.Acceleration = Mathf.Clamp(baseStats.Acceleration * 0.5f, minValueAcce, baseStats.Acceleration);
        }
