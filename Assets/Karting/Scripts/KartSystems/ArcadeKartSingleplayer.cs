...
{
    public class ArcadeKartSingleplayer : MonoBehaviour
    {
        [System.Serializable]
        public class StatPowerup
        {
            public ArcadeKartSingleplayer.Stats modifiers;
        ...
        public ArcadeKartSingleplayer.Stats baseStats = new ArcadeKartSingleplayer.Stats
        {
            TopSpeed = 10f,
            Acceleration = 5f,
        ...
        ArcadeKartSingleplayer.Stats m_FinalStats;
